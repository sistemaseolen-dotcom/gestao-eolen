...
export default async function Page({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <main className="p-6">
      <h1 className="mb-4 text-xl font-semibold">Editar: Projetos</h1>
      <CatalogForm action={action} basePath={config.basePath} submitLabel="Salvar" initial={item as any} hasLogoUrl={true} />
    </main>
  );
}
